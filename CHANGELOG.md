...
Entries from 0.4.0 onwards are generated by
[release-please](https://github.com/googleapis/release-please) from
[Conventional Commits](https://www.conventionalcommits.org/) — do not edit this
file by hand.

## [0.5.0](https://github.com/DEVtheOPS/kore/compare/v0.4.0...v0.5.0) (2026-09-11)


### Features

* in-app update checks and one-click install ([#16](https://github.com/DEVtheOPS/kore/issues/16)) ([e9c9f46](https://github.com/DEVtheOPS/kore/commit/e9c9f461f7ac40e72b0f18e4684a6b4ffaee537c))


### Bug Fixes

* import login-shell PATH so kubeconfig exec plugins resolve ([fade9b6](https://github.com/DEVtheOPS/kore/commit/fade9b6ed7e12398fa96fc34fa23be5cd628b842))
* **ui:** show loading state in tables instead of an empty message ([b6c85fd](https://github.com/DEVtheOPS/kore/commit/b6c85fdc4f6609b0b96954662f6ad46629142812))

## [0.4.0](https://github.com/DEVtheOPS/kore/compare/v0.2.0...v0.4.0) (2026-09-07)


### Features

* add comprehensive issue templates and security policy ([9387784](https://github.com/DEVtheOPS/kore/commit/93877841ebfeb639e188b430750d351dd3ea67dc))
* add Starlight docs site and screenshot CI ([10bd834](https://github.com/DEVtheOPS/kore/commit/10bd834e967b8c47a89477cfdf7ce3a21dc07d32))
* switch to bun, finish rebrand, live metrics, and complete stubbed features ([7dd4634](https://github.com/DEVtheOPS/kore/commit/7dd463441d5c3ebaeba54abd831c73eaab2f2534))


### Bug Fixes

* **deps:** resolve dependabot alerts for npm and cargo ([3394b8a](https://github.com/DEVtheOPS/kore/commit/3394b8af40b8017122f5267166442399578bf236))
